...
selectedOptionsContainer.classList.add('selected');
selectedOptionsContainer.style.borderRadius = '20px';
...
allOptions.forEach(option => {
  ...
  price.textContent = '$' + option.price + "/yr";
...
//totalLabel.style.backgroundColor = 'white';
